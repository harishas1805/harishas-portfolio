...
async function seedData() {
    try {
        ...
        // 1. Skills
        // Note: Assuming "Skills" logic. Adding simplified rows based on observed HTML structure or generic needs.
        // Since original asked for "Title" and "technologies learned", we can map categories.
        const skills = [
            {
                title: 'Data Science & ML',
                technologies: 'Python, TensorFlow, PyTorch, Scikit-learn, Pandas, NumPy, OpenCV, NLP',
                order: 1
            },
            {
                title: 'Web Development',
                technologies: 'HTML5, CSS3, JavaScript, Flask, Django, React.js, Node.js',
                order: 2
            },
            {
                title: 'Database & Cloud',
                technologies: 'MySQL, PostgreSQL, MongoDB, AWS, Google Cloud, Docker, Git',
                order: 3
            }
        ];
        ...
        for (const skill of skills) {
            await db.query(`
                INSERT INTO skills (title, technologies, display_order) 
                VALUES ($1, $2, $3)
            `, [skill.title, skill.technologies, skill.order]);
        }
